...
We provide some probes at [HuggingFace]([https://huggingface.co/FTK11558](https://huggingface.co/collections/FTK11558/aps-jailbreak)). You can directly load them with ```from_pretrained```. You can also load them with vllm. 
