"""Steered Mistral for Transformers (HF).
...
layers listed in ``config.steered_layers``. Usage::
    ...
    from SteeredMistralForCausalLM import SteeredMistralForCausalLM
    model = SteeredMistralForCausalLM.from_pretrained(steered_dir)
"""
...
class SteeredMistralForCausalLM(MistralForCausalLM):
