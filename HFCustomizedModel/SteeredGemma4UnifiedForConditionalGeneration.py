"""Steered Gemma4 Unified (multimodal) for Transformers (HF).
...
layers listed in ``config.steered_layers``. Usage::
    ...
    from SteeredGemma4UnifiedForConditionalGeneration import SteeredGemma4UnifiedForConditionalGeneration
    model = SteeredGemma4UnifiedForConditionalGeneration.from_pretrained(steered_dir)
"""
...
class SteeredGemma4UnifiedForConditionalGeneration(Gemma4UnifiedForConditionalGeneration):
