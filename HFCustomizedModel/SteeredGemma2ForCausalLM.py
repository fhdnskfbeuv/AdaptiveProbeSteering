"""Steered Gemma2 for Transformers (HF).
...
layers listed in ``config.steered_layers``. Usage::
    ...
    from SteeredGemma2ForCausalLM import SteeredGemma2ForCausalLM
    model = SteeredGemma2ForCausalLM.from_pretrained(steered_dir)
"""
